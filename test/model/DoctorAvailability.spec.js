...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DoctorAvailability', function() {
      beforeEach(function() {
        instance = new MedicalSystemApi.DoctorAvailability();
      });

      it('should create an instance of DoctorAvailability', function() {
        // TODO: update the code to test DoctorAvailability
        expect(instance).to.be.a(MedicalSystemApi.DoctorAvailability);
      });
